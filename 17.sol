...
взаимодействия с различными активами (хранение в mapping адреса и пересланных 
...
с другими смарт-контрактами через свой смарт-контракт. Таким образом у externally-owned аккаунт
всегда будет возможность взаимодействовать с другими контрактами напрямую в случае обнаружения
неисправности своего смарт-контракта и без потери своих сбережений. Но лучше всего избегать
...
contract A {
    ...
    //если функции вызваны напрямую с данного контракта, то
...
contract B {
    ...
    constructor(address _a) {
      ...
      //sender = адрес контракта B в случае вызова с контракта C
